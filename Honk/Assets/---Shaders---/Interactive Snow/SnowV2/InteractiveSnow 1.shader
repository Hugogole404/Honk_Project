Shader "Custom/Snow Interactive Test" {
    Properties{
        [Header(Main)]
        ...
        _SnowBorder("Snow Border", Range(0,2)) = 0.3
        _StartBorder("Start Border", Range(0,1)) = 0.3
        _EndBorder("End Border", Range(0,1)) = 0.5
    ...
    #include "SnowTessellation 1.hlsl"
    ...
    SubShader{
        ...
        Pass{
            ...
            float _RimPower;
            float4 _PathColorIn, _PathColorOut, _PathColorBorder;
            float _PathBlending;
            ...
            half4 frag(Varyings IN) : SV_Target{
                ...
                float border = smoothstep(0, _StartBorder, effect.g);
                border *= 1 - smoothstep(_StartBorder, _EndBorder, effect.g);

                //effect = smoothstep(0, 1, effect);
                ...
                path = lerp(path, _PathColorBorder.rgb, saturate(border));
                ...
                //final.rgb = saturate(border + effect.g);
                return final;
